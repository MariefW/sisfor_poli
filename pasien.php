...
<html lang="en">
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="pasien.php">Pasien<span class="sr-only">(current)</span></a></li>
  ...
  <nav>
    <a href="tambah_pasien.php">[+] Tambah Data Baru</a>
  </nav>
  <br>
  ...
  <tbody>
    ...
    while($pasien = mysqli_fetch_array($query)){
      ...
      echo "<td>".$pasien['telp']."</td>";
      echo "<td>".$pasien['tgl_lahir']."</td>";
      echo "<td>".$pasien['jenis_kelamin']."</td>";
      echo "<td><a href='edit_pasien.php?id=".$pasien['id']."'class='btn btn-success'>Edit</button></a> | ";
      echo "<a href='hapus_pasien.php?id=".$pasien['id']."'class='btn btn-danger'>Hapus</a></td>";
      echo "</td>";
      $no++;
    }
    ?>
