...
<body>
    ...
    <form action="" method="POST">
      ...
      <p>
          ...
          <input type="text" name="alamat" value="<?php echo $pasien['alamat'] ?>"/>
      </p>
      <p>
          <label for="nama">No. Telp : </label>
          <input type="number" id="phone" name="telp" value="<?php echo $pasien['telp'] ?>">
      </p>
      <p>
          <label for="nama">Tgl. Lahir : </label>
          <input type="date" name="tgl_lahir" value="<?php echo $pasien['tgl_lahir'] ?>"/>
      </p>
      <p>
...
if(isset($_POST['simpan'])){
    ...
    // buat query update
    $sql = "UPDATE pasien SET nama='$nama', alamat='$alamat',telp='$telp',tgl_lahir='$lahir',jenis_kelamin='$jk' WHERE id=$id";
    $query = mysqli_query($db, $sql);
